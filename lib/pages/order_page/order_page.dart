...
class _OrderPageState extends State<OrderPage> {
  ...
  allOrder() async {
    final val = Provider.of<OrderpageProvider>(listen: false, context);
    id = FirebaseAuth.instance.currentUser!.uid;
    val.setOrderStream(await FirebaseMethod.orderSnapshot(id!));
